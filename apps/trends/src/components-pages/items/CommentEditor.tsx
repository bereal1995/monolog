...
import LoadingIndicator from '@/components-shared/system/LoadingIndicator'
    ...
    <Block>
      ...
      <AnimatePresence>
        {isButtonsShown || mode !== 'write' ? (
          <Actions key="actions" initial={mode === 'write' ? { height: 0 } : false} animate={{ height: 36 }} exit={{ height: 0 }}>
